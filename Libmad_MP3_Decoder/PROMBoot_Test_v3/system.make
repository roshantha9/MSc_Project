...
# D:\Xtemp\PROMBoot_Test_v3\system.mhs
# The software specification of the system is in file :
# D:\Xtemp\PROMBoot_Test_v3\system.mss
...
SDRAMApp_program: $(SDRAMAPP_OUTPUT) 

$(SDRAMAPP_OUTPUT) : $(SDRAMAPP_SOURCES) $(SDRAMAPP_HEADERS) $(SDRAMAPP_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/sdramapp_compiler.opt
	@mkdir -p $(SDRAMAPP_OUTPUT_DIR) 
	$(SDRAMAPP_CC) $(SDRAMAPP_CC_OPT) $(SDRAMAPP_SOURCES) -o $(SDRAMAPP_OUTPUT) \
	$(SDRAMAPP_OTHER_CC_FLAGS) $(SDRAMAPP_INCLUDES) $(SDRAMAPP_LIBPATH) \
	$(SDRAMAPP_CFLAGS) $(SDRAMAPP_LFLAGS) 
	$(SDRAMAPP_CC_SIZE) $(SDRAMAPP_OUTPUT) 
	@echo ""

SDRAMApp_programclean:
	rm -f $(SDRAMAPP_OUTPUT) 
