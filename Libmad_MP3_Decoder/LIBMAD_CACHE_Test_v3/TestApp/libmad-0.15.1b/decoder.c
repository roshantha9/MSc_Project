						    ...
						    void *, unsigned int *))
{
    ...
    #if X_DEBUG
        xil_printf("mad_decoder_init::Enter\r\n");
    #endif
...
int mad_decoder_finish(struct mad_decoder *decoder)
{
    ...
    #if X_DEBUG
        xil_printf("mad_decoder_finish::Enter\r\n");
    #endif
			    ...
			    struct mad_frame *frame)
{
  int *bad_last_frame = data;
    ...
    #if X_DEBUG
        xil_printf("error_default::Enter\r\n");
    #endif
...
int mad_decoder_run(struct mad_decoder *decoder, enum mad_decoder_mode mode)
{
  ...
  #if X_DEBUG
       xil_printf("mad_decoder_run::Enter\r\n");
  #endif
...
//  }
  ...
  //xil_printf("mad_decoder_run::before run pointer alloc - run=0x%X, run_sync=0x%X\r\n", run, run_sync);
  ...
  //xil_printf("mad_decoder_run::sizeof(*decoder->sync) = %d\r\n", sizeof(*decoder->sync));


  decoder->sync = malloc(sizeof(*decoder->sync));

  if (decoder->sync == NULL){
    xil_printf("mad_decoder_run::malloc failed!\r\n");
    return -1;
  }

   //xil_printf("mad_decoder_run::malloc success = 0x%X\r\n", decoder->sync);
			...
			void *message, unsigned int *len)
{
  ...
  #if X_DEBUG
    xil_printf("mad_decoder_message::Enter\r\n");
  #endif
